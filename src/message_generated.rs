...
pub mod asted {
	...
	pub mod interface {
		...
		pub mod tree {
			...
			// struct Location, aligned to 8
			#[repr(transparent)]
			#[derive(Clone, Copy, PartialEq)]
			pub struct Location(pub [u8; 16]);
			...
			impl<'a> Location {
				...
				pub fn set_start_byte(&mut self, x: u64) {
				...
				pub fn set_end_byte(&mut self, x: u64) {
					let x_le = x.to_little_endian();
					// Safety:
					// Created from a valid Table for this object
					// Which contains a valid value in this slot
			...
			impl<'a> Node<'a> {
				...
				pub fn kind(&self) -> &'a str {
					...
					unsafe {
						self._tab
							.get::<flatbuffers::ForwardsUOffset<&str>>(Node::VT_KIND, None)
							.unwrap()
					}
				}
				#[inline]
			...
			impl<'a: 'b, 'b> NodeBuilder<'a, 'b> {
				...
				pub fn add_kind(&mut self, kind: flatbuffers::WIPOffset<&'b str>) {
					self.fbb_
						.push_slot_always::<flatbuffers::WIPOffset<_>>(Node::VT_KIND, kind);
				}
				#[inline]
				pub fn add_location(&mut self, location: &Location) {
					self.fbb_
						.push_slot_always::<&Location>(Node::VT_LOCATION, location);
				}
				#[inline]
				pub fn add_children(
					&mut self,
				...
				pub fn add_text(
					&mut self,
					text: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>,
				) {
					self.fbb_
						.push_slot_always::<flatbuffers::WIPOffset<_>>(Node::VT_TEXT, text);
				}
				#[inline]
				pub fn new(
		...
		pub const ENUM_MAX_ERROR_KIND: i8 = 0;
		#[deprecated(
			since = "2.0.0",
			note = "Use associated constants instead. This will no longer be generated in 2021."
		)]
		#[allow(non_camel_case_types)]
		pub const ENUM_VALUES_ERROR_KIND: [ErrorKind; 1] = [ErrorKind::UnknownLang];
		...
		impl ErrorKind {
			pub const UnknownLang: Self = Self(0);

			pub const ENUM_MIN: i8 = 0;
			pub const ENUM_MAX: i8 = 0;
			pub const ENUM_VALUES: &'static [Self] = &[Self::UnknownLang];
			/// Returns the variant's name or "" if unknown.
			pub fn variant_name(self) -> Option<&'static str> {
				match self {
					Self::UnknownLang => Some("UnknownLang"),
					_ => None,
				}
			}
		}
		...
		impl RequestUnion {
			...
			pub const ENUM_VALUES: &'static [Self] =
				&[Self::NONE, Self::InitRequest, Self::FileRequest];
			/// Returns the variant's name or "" if unknown.
			pub fn variant_name(self) -> Option<&'static str> {
				match self {
					Self::NONE => Some("NONE"),
		...
		impl<'a> Error<'a> {
			...
			pub fn kind(&self) -> ErrorKind {
				...
				unsafe {
					self._tab
						.get::<ErrorKind>(Error::VT_KIND, Some(ErrorKind::UnknownLang))
						.unwrap()
				}
			}
			#[inline]
		...
		impl<'a: 'b, 'b> ErrorBuilder<'a, 'b> {
			...
			pub fn add_kind(&mut self, kind: ErrorKind) {
				self.fbb_
					.push_slot::<ErrorKind>(Error::VT_KIND, kind, ErrorKind::UnknownLang);
			}
			#[inline]
		...
		impl<'a> InitRequest<'a> {
			...
			pub fn lang(&self) -> &'a str {
				...
				unsafe {
					self._tab
						.get::<flatbuffers::ForwardsUOffset<&str>>(InitRequest::VT_LANG, None)
						.unwrap()
				}
			}
		}
		...
		impl<'a: 'b, 'b> InitRequestBuilder<'a, 'b> {
			...
			pub fn add_lang(&mut self, lang: flatbuffers::WIPOffset<&'b str>) {
				self.fbb_
					.push_slot_always::<flatbuffers::WIPOffset<_>>(InitRequest::VT_LANG, lang);
			}
			#[inline]
			pub fn new(
				_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
			) -> InitRequestBuilder<'a, 'b> {
				let start = _fbb.start_table();
				InitRequestBuilder {
					fbb_: _fbb,
					start_: start,
		...
		impl<'a> flatbuffers::Follow<'a> for InitResponse<'a> {
			type Inner = InitResponse<'a>;
			#[inline]
			unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
				Self {
					_tab: flatbuffers::Table::new(buf, loc),
		...
		impl<'a> InitResponse<'a> {
			pub const VT_ERR: flatbuffers::VOffsetT = 4;

			#[inline]
			pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
				InitResponse { _tab: table }
			}
			#[allow(unused_mut)]
			pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
				_fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr>,
				args: &'args InitResponseArgs<'args>,
			) -> flatbuffers::WIPOffset<InitResponse<'bldr>> {
				let mut builder = InitResponseBuilder::new(_fbb);
			...
			pub fn err(&self) -> Option<Error<'a>> {
				...
				unsafe {
					self._tab
						.get::<flatbuffers::ForwardsUOffset<Error>>(InitResponse::VT_ERR, None)
				}
			}
		}

		impl flatbuffers::Verifiable for InitResponse<'_> {
			#[inline]
			fn run_verifier(
				v: &mut flatbuffers::Verifier,
				pos: usize,
				...
				use self::flatbuffers::Verifiable;
				v.visit_table(pos)?
					.visit_field::<flatbuffers::ForwardsUOffset<Error>>("err", Self::VT_ERR, false)?
					.finish();
				Ok(())
			}
		}
		pub struct InitResponseArgs<'a> {
			pub err: Option<flatbuffers::WIPOffset<Error<'a>>>,
		}
		impl<'a> Default for InitResponseArgs<'a> {
			#[inline]
			fn default() -> Self {
				InitResponseArgs { err: None }
			}
		}

		pub struct InitResponseBuilder<'a: 'b, 'b> {
			fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
			start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
		}
		impl<'a: 'b, 'b> InitResponseBuilder<'a, 'b> {
			#[inline]
			pub fn add_err(&mut self, err: flatbuffers::WIPOffset<Error<'b>>) {
				self.fbb_
					.push_slot_always::<flatbuffers::WIPOffset<Error>>(InitResponse::VT_ERR, err);
			}
			#[inline]
			pub fn new(
				_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
			) -> InitResponseBuilder<'a, 'b> {
				let start = _fbb.start_table();
				InitResponseBuilder {
					fbb_: _fbb,
					start_: start,
			...
			#[inline]
			pub fn finish(self) -> flatbuffers::WIPOffset<InitResponse<'a>> {
				let o = self.fbb_.end_table(self.start_);
				flatbuffers::WIPOffset::new(o.value())
			}
		}

		impl core::fmt::Debug for InitResponse<'_> {
			fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
				let mut ds = f.debug_struct("InitResponse");
		...
		impl<'a> FileRequest<'a> {
			...
			pub fn path(&self) -> &'a str {
				...
				unsafe {
					self._tab
						.get::<flatbuffers::ForwardsUOffset<&str>>(FileRequest::VT_PATH, None)
						.unwrap()
				}
			}
		}
		...
		impl<'a: 'b, 'b> FileRequestBuilder<'a, 'b> {
			...
			pub fn add_path(&mut self, path: flatbuffers::WIPOffset<&'b str>) {
				self.fbb_
					.push_slot_always::<flatbuffers::WIPOffset<_>>(FileRequest::VT_PATH, path);
			}
			#[inline]
			pub fn new(
				_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
			) -> FileRequestBuilder<'a, 'b> {
				let start = _fbb.start_table();
				FileRequestBuilder {
					fbb_: _fbb,
					start_: start,
		...
		impl<'a> FileResponse<'a> {
			...
			#[inline]
			pub fn tree(&self) -> Option<tree::Node<'a>> {
				// Safety:
				// Created from valid Table for this object
				// which contains a valid value in this slot
				unsafe {
					self._tab.get::<flatbuffers::ForwardsUOffset<tree::Node>>(
						FileResponse::VT_TREE,
						None,
					)
				}
			}
		...
		impl flatbuffers::Verifiable for FileResponse<'_> {
			...
			fn run_verifier(
				...
				use self::flatbuffers::Verifiable;
				v.visit_table(pos)?
					.visit_field::<flatbuffers::ForwardsUOffset<tree::Node>>(
						"tree",
						Self::VT_TREE,
						false,
					)?
		...
		pub struct FileResponseArgs<'a> {
			pub tree: Option<flatbuffers::WIPOffset<tree::Node<'a>>>,
		}
		impl<'a> Default for FileResponseArgs<'a> {
			#[inline]
			fn default() -> Self {
				FileResponseArgs { tree: None }
			}
		}
		...
		impl<'a: 'b, 'b> FileResponseBuilder<'a, 'b> {
			#[inline]
			pub fn add_tree(&mut self, tree: flatbuffers::WIPOffset<tree::Node<'b>>) {
				self.fbb_
					.push_slot_always::<flatbuffers::WIPOffset<tree::Node>>(
						FileResponse::VT_TREE,
						tree,
					);
			}
		...
		impl flatbuffers::Verifiable for Request<'_> {
			...
			fn run_verifier(
				...
				use self::flatbuffers::Verifiable;
				v.visit_table(pos)?
					.visit_union::<RequestUnion, _>(
						"request_type",
						Self::VT_REQUEST_TYPE,
						"request",
						Self::VT_REQUEST,
						true,
						|key, v, pos| match key {
							RequestUnion::InitRequest => v
								.verify_union_variant::<flatbuffers::ForwardsUOffset<InitRequest>>(
									"RequestUnion::InitRequest",
									pos,
								),
							RequestUnion::FileRequest => v
								.verify_union_variant::<flatbuffers::ForwardsUOffset<FileRequest>>(
									"RequestUnion::FileRequest",
									pos,
								),
							_ => Ok(()),
		...
		#[inline]
		pub fn finish_size_prefixed_request_buffer<'a, 'b>(
			fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
			root: flatbuffers::WIPOffset<Request<'a>>,
		) {
